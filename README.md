...
- **丰富角色卡**：内置 16 套精心设计的人设，支持一键新建、编辑、导入 / 导出自己的角色卡
...
- **精美界面**：全新高清应用图标与启动屏（超采样抗锯齿绘制），主题可选跟随系统 / 深色 / 浅色
- **赞赏支持**：内置开发者收款码，喜欢就请开发者喝杯咖啡
- **语音朗读**：调用系统 TTS，免费离线朗读
- **个性头像**：渐变头像 / 上传图片头像
- **数据自主**：所有数据仅存本机，支持一键备份 / 恢复 / 清空
- **界面美观**：高清应用图标与启动屏，主题支持跟随系统 / 深色 / 浅色，移动端优先 + 桌面端适配，PWA 可安装到桌面

## 快速开始

### 手机安装（Android APK）

1. 一键构建脚本会产出安装包到 `dist/星语AI-v1.2.0.apk`：
